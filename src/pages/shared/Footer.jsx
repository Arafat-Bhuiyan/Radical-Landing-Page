        ...
        <div className="flex flex-col lg:flex-row justify-between gap-10 lg:gap-4 mb-8 lg:mb-11">
          ...
          <div className="text-black font-unbounded leading-normal flex flex-col justify-start items-start ">
            ...
            <ul className="space-y-2 text-xs font-normal">
              <li className="!list-none">
                <a
                  href="/"
                  className="hover:text-[#EB4DAC] !text-black transition-colors text-sm"
                >
                  Home
                </a>
              </li>
              <li className="!list-none">
                <a
                  href="http://10.10.13.12:5173/our-mission"
              ...
              <li className="!list-none">
                <a
                  href="http://10.10.13.12:5173/about-us-details"
                  className="hover:text-[#EB4DAC] !text-black transition-colors"
                >
                  About
                </a>
              ...
              <li className="!list-none">
                <a
                  href="http://10.10.13.12:5173/contact"
                  className="hover:text-[#EB4DAC] !text-black transition-colors"
                >
                  Contact
                </a>
          ...
          <div className="text-black font-unbounded leading-normal flex flex-col justify-start items-start ">
            ...
            <ul className="space-y-2 text-xs font-normal">
              <li className="!list-none">
                <a
                  href="http://10.10.13.12:5173/terms"
                  className="hover:text-[#EB4DAC] !text-black transition-colors"
                >
                  Terms & Conditions
                </a>
              ...
              <li className="!list-none">
                <a
                  href="http://10.10.13.12:5173/privacy"
                  className="hover:text-[#EB4DAC] !text-black transition-colors"
                >
                  Privacy Policy
                </a>
